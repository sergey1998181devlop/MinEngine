...
<script>
	...
	function initMap() {
		map = new google.maps.Map(document.getElementById('gmap'), {
		  center: {lat: 55.7691259, lng: 37.6371755},
		  zoom: 15,
		  styles: styles
		});
   ...
   return function() { infowindow.open(map, marker);
      ...
      content: "<div class=infowindow><h1>Уланский переулок</h1><p>Тихая улица в центре Москвы</p></div>"
   });
      ...
      content: "<div class=infowindow><p>200 метров до Садового кольца</p></div>"
		...
		var marker = new google.maps.Marker({
			position: {lat: 55.763890, lng: 37.640609},
			map: map,
